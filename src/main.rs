...
const LAYER_LEN: [usize; N_LAYERS] = [17, 17, 200];
...
const VEC_LEN: usize = 11013;
const POP_SIZE: usize = 113;
const ELITE: usize = 44;
const N_GEN: usize = 99999999;
const PROB_EML: f64 = 0.00766409;
const A: f64 = 0.19277155;
const B: f64 = 0.43417885;
const C: f64 = 1.25726153;
const D: f64 = 0.99457427;
const E: f64 = 1.71424588;
const HILO: f64 = 14.20157152;
const P: f64 = 1.37620072;
const MUT_STOP_PROB: f64 = 5.47987234;
const MUT_MAX_TARGETS: usize = 53;

// ─── Surrogate Model ハイパーパラメータ ─────────────────────────────────────
/// Tree-structured MLP の埋め込み次元 n
const SURR_EMBED_DIM: usize = 47;
/// Tree-structured MLP の隠れ次元 m  (n*2 → Linear → m → Swish → Linear → n)
const SURR_HIDDEN_DIM: usize = 107;
/// Muon Optimizer の学習率
const SURR_LR: f64 = 0.00011549;
/// surrogate ステップ / 実評価ステップの比率 (初期値)
const SURR_RATIO_INIT: f64 = 2.04254274;
/// surrogate のバリデーション相関がこの値を超えたら surrogate ステップ倍率を上げる
const SURR_PROMOTE_THRESH: f64 = 0.91039014;
/// surrogate のバリデーション相関がこの値を下回ったら surrogate ステップ倍率を下げる
const SURR_DEMOTE_THRESH: f64 = 0.01552258;
/// surrogate ステップ数の最大倍率 (SURR_RATIO_INIT に対する乗数上限)
const SURR_MAX_MULTIPLIER: f64 = 3.01830924;
